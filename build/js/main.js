...
mainRoomsContainer.addEventListener('click', (e) => {
    ...
    if (selectedElement === null || selectedElement === void 0 ? void 0 : selectedElement.closest('.light-switch')) {
        const lightSwitch = (_a = selectedElement === null || selectedElement === void 0 ? void 0 : selectedElement.closest('.basic_settings_buttons')) === null || _a === void 0 ? void 0 : _a.firstElementChild;
...
advanceFeaturesContainer.addEventListener('click', (e) => {
    ...
    if ((_a = selectedElement === null || selectedElement === void 0 ? void 0 : selectedElement.textContent) === null || _a === void 0 ? void 0 : _a.includes('Cancel')) {
