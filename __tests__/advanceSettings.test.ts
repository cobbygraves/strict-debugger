...
describe('Advance settings functionality', () => {
  ...
  test('should cancel auto-on customization', () => {
    ...
    `
    const btn = document.querySelector('.defaultOn-cancel') as HTMLElement
    advance.customizationCancelled(btn, '.defaultOn')

    const input = document.querySelector('.defaultOn input') as HTMLInputElement
  ...
  test('should cancel auto-off customization', () => {
    ...
    `
    const btn = document.querySelector('.defaultOff-cancel') as HTMLElement
